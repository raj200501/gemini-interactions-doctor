...
- Generate interaction event schemas and sample regression JSONL files.
- Add `gdoctor rules`.
...
- Initial MVP with Gemini readiness scanning, report rendering, patch generation, examples, tests, and CI.
